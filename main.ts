...
import type { InternalHistoryOptions, IobDataEntry, HistoryAdapterConfig } from './lib/types';
                ...
                gh.on('message', (rawData: unknown): void => {
                    ...
                    if (getCacheCommand[0] === 'getCache') {
                        ...
                        try {
                            ...
                            this.log.info(`${options.logId} Can not exit forked process: ${(err as Error).message}`);
                        }
                        gh = null;
